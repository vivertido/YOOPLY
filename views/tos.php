				...
				<!-- Inner -->
					<div class="inner">
						<header class="header-background">
							<h1><a href="#" id="logo">Yooply</a></h1>
							<span class="byline">School Behavior Solutions</span>
						</header>
					</div>
					...
					<div class="row">
						<div class="12u skel-cell-important" id="content">
							<article id="main" class="special">
								<header>
									<h2><a href="#">Terms of Service for Yooply</a></h2>
									 
								</header>
								
								
<h3>Introduction</h3>
<p>Yooply, yoop.ly, is owned and operated by sleek-geek inc. By visiting our website(s) and accessing the information, resources, services, products, and tools we provide, you understand and agree to accept and adhere to the following terms and conditions as stated in this policy (hereafter referred to as 'User Agreement').</p>

<p>This agreement is in effect as of March, 17, 2015.</p>
...
<p>iiii. Impersonates any person or entity, including any Sleek-geek, Inc. employees or representatives.</p>
...
<p>vi) no information or advice, whether expressed, implied, oral or written, obtained by you from Read With Me or through any Resources we provide shall create any warranty, guarantee, or conditions of any kind, except for those expressly outlined in this User Agreement.</p>

<h3>Limitation of Liability</h3>
<p>In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services. Neither Yooply, nor its parent company, board of directors, employees will be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply.</p>

<h3>Copyrights/Trademarks</h3>
<p>All content and materials available on readwithmeapp.com, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of sleek-geek inc., and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by Yooply.</p>
...
<h3>Governing Law</h3>
<p>This website is controlled by sleek-geek inc. from our offices located in the state of California, United States of America. It can be accessed by most countries around the world. As each country has laws that may differ from those of California, by accessing our website, you agree that the statutes and laws of California, without regard to the conflict of laws and the United Nations Convention on the International Sales of Goods, will apply to all matters relating to the use of this website and the purchase of any products or services through this site. Furthermore, any action to enforce this User Agreement shall be brought in the federal or state courts located in California, United States of America. You hereby agree to personal jurisdiction by such courts, and waive any jurisdictional, venue, or inconvenient forum objections to such courts.</p>

<h3>Guarantee</h3>
<p>UNLESS OTHERWISE EXPRESSED, Yoop.ly EXPRESSLY DISCLAIMS ALL WARRANTIES AND CONDITIONS OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO THE IMPLIED WARRANTIES AND CONDITIONS OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT.</p>

<h3>Contact Information</h3>
<p>If you have any questions or comments about these our Terms of Service as outlined above, you can contact us at:</p>
<p><a href="http://yoop.ly/contact">Yoop.ly/contact</a></p>
					...
					<div class="row">
						<div class="12u">
							...
							<!-- Copyright -->
								<div class="copyright">
									<ul class="menu">
										<li>&copy; sleek-geek, inc. All rights reserved. 2015</li>
