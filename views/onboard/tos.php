<h2>Terms of Service for Yooply</h2>
...
<form action="/onboard/tos/<?= $invitecode ?>" method="POST" data-ajax="false">
	<input type="submit" name="submit" value="I agree to the Terms of Service" />
</form>