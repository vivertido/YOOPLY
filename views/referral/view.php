...
<ul data-role="listview" data-inset="true">
	<?php if($this->session->userdata('role') == 'a'): ?>
		<?php if($referral->timecheckin == 0): ?><li><a href="/referral/checkinstudent/<?= $referral->referralid ?>" data-ajax="false">Checkin Student</a></li><?php endif; ?>
		<?php if($referral->timecheckin != 0 && $referral->timecheckout == 0): ?><li><a href="/referral/sendbacktoclass/<?= $referral->referralid ?>" data-ajax="false">Checkout Student</a></li><?php endif; ?>		
		<li><a href="/consequence/add/referral/<?= $referral->referralid ?>" data-ajax="false">Add Consequence</a></li>
	<?php endif; ?>
	<li><a href="/referral/edit/<?= $referral->referralid ?>">Edit</a></li>
	<li data-theme="c"><a href="/referral/remove/<?= $referral->referralid ?>" data-ajax="false" >Remove</a></li>
</ul>